...
src/
    ...
    service/                                        # Слой бизнес-логики
        ...
        IBalanceRecalculator.java                   # интерфейс севрвиса, для пересчета баланса
...
1. Легко подменять реализацию репозиториев (если меняем тип хранилища, СУБД базы данных и пр.)
